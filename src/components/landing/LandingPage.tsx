      ...
      <div className="max-w-4xl mx-auto text-center space-y-12 animate-fadeIn">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white">
            ...
            <span className="text-purple-400">Cut Costs and Optimize Efficiency Instantly!</span>
          </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-center py-8">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-sm text-gray-300">Unused Licenses</div>
              </div>
              <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-sm text-gray-300">Optimization Areas</div>
              </div>
            </div>
            <Button
        ...
        >
          <Card className="p-8 bg-[#221F26] shadow-xl rounded-2xl border-0">
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-gray-300 text-center">Identify savings opportunities and optimize license usage</p>
            </div>
          </Card>
          ...
          <Card className="p-8 bg-[#221F26] shadow-xl rounded-2xl border-0">
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-gray-300 text-center">Get actionable insights to reduce costs</p>
            </div>
          </Card>
          ...
          <Card className="p-8 bg-[#221F26] shadow-xl rounded-2xl border-0">
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-gray-300 text-center">Enterprise-grade security with data privacy controls</p>
            </div>
          </Card>
        </div>
        ...
        <footer className="mt-16 border-t border-gray-800 pt-8">
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300 font-medium">Trusted by Salesforce Users</span>
            </div>
